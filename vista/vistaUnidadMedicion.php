...
if (isset($_POST['txtid'])) $idUnidadMedicion = $_POST['txtid'];
if (isset($_POST['txtdescripcionUnidadMedicion'])) $descripcionUnidadMedicion = $_POST['txtdescripcionUnidadMedicion'];
switch ($boton) {
    case 'Guardar':
        $objUnidadMedicion = new UnidadMedicion($idUnidadMedicion, $descripcionUnidadMedicion);
        ...
        break;
    case 'Consultar':
        $objUnidadMedicion = new UnidadMedicion($idUnidadMedicion, "");
        $objControlUnidadMedicion = new ControlUnidadMedicion($objUnidadMedicion);
        $objUnidadMedicion = $objControlUnidadMedicion->consultar();
        $descripcionUnidadMedicion = $objUnidadMedicion->getdescripcionUnidadMedicion();
        break;
    case 'Modificar':
        $objUnidadMedicion = new UnidadMedicion($idUnidadMedicion, $descripcionUnidadMedicion);
        $objControlUnidadMedicion = new ControlUnidadMedicion($objUnidadMedicion);
...
<head>
    ...
    <title>Unidad de Medición</title>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2 class="miEstilo">Gestión <b>Unidad de Medición</b></h2>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $arregloUnidadMedicion[$i]->getIdUnidadMedicion(); ?></td>
                                <td><?php echo $arregloUnidadMedicion[$i]->getdescripcionUnidadMedicion(); ?></td>
                                <td>
                ...
                <form action="vistaUnidadMedicion.php" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>id</label>
                            <input type="id" id="txtid" name="txtid" class="form-control" value="<?php echo $idUnidadMedicion ?>">
                        </div>
                        <div class="form-group">
                            <label>Descripción</label>
                            <input type="descripcionUnidadMedicion" id="txtdescripcionUnidadMedicion" name="txtdescripcionUnidadMedicion" class="form-control" value="<?php echo $descripcionUnidadMedicion ?>">
                        </div>
                        <div class="form-group">
